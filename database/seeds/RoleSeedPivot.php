...
class RoleSeedPivot extends Seeder
{
    ...
    public function run()
    {
        $items = [
            ...
            4 => [
                'permission' => [1, 2, 3, 4, 6, 9, 16, 17, 18, 19, 26, 27, 28, 29, 31, 32, 33, 34, 36, 37, 38, 39, 41, 42, 43, 44, 45, 47, 48, 49, 50, 52, 53, 54, 55, 57, 58, 59, 60, 63, 64, 65, 66, 67, 68, 69, 70, 71, 72, 74, 75, 76, 77, 114, 115, 116, 117, 118],
            ],
