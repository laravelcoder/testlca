    ...
    public function testCreateBooking()
    {
        ...
        $this->browse(function (Browser $browser) use ($admin, $booking) {
            $browser->loginAs($admin)
                ...
                ->assertSeeIn("tr:last-child td[field-key='requested_time']", $booking->requested_time)
    ...
    public function testEditBooking()
    {
        ...
        $this->browse(function (Browser $browser) use ($admin, $booking, $booking2) {
            $browser->loginAs($admin)
                ...
                ->assertSeeIn("tr:last-child td[field-key='requested_time']", $booking2->requested_time)
